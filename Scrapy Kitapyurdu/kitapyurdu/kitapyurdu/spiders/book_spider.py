...
class BooksSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        i = 0
        self.file.write("------------------------------------------------------\n")
        self.file.write( "   Kitapyurdu.com ÇOK SATAN KİTAPLAR LİSTESİ \n")
        while (i < len(book_names)):
         
            
            self.file.write("------------------------------------------------------\n")
            self.file.write(str(self.book_count) + ". " + "Kitap İsmi: " + book_names[i] + "   " + "Yazar: " + book_authors[i] + "  " + "Yayıncı: " + book_publishers[i] + "\n")
            self.book_count += 1
